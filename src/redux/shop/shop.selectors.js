...
export const selectParticularProductSelector = (collectionId, product) =>
  createSelector([selectShopCollectionsSelector], (collections) =>
    collections[collectionId].items.find((item) => item.name === product)
  );
